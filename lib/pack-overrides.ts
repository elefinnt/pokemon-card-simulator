...
export const PACK_OVERRIDES: Record<CuratedSetId, PackOverride> = {
  ...
  base4: {
    ...
    accentFrom: '#2563eb',
    accentTo: '#991b1b',
    blurb: 'The classic Base Set returns, Charizard included.',
  },
  base5: {
    slug: 'team-rocket',
    accentFrom: '#dc2626',
  ...
  gym1: {
    ...
    accentFrom: '#eab308',
    accentTo: '#1e3a8a',
    blurb: 'Take on the Kanto gym leaders and their signature Pokémon.',
  },
  gym2: {
    slug: 'gym-challenge',
    accentFrom: '#f97316',
  ...
  base6: {
    ...
    accentFrom: '#f59e0b',
    accentTo: '#7f1d1d',
    blurb: 'Fireworks holos and the highlights of the classic era in one set.',
  },
  ecard2: {
    slug: 'aquapolis',
    accentFrom: '#14b8a6',
    accentTo: '#134e4a',
    blurb: 'The lost city of Aquapolis, home of Crystal Pokémon and e-Reader secrets.',
  },
  ecard3: {
    slug: 'skyridge',
    accentFrom: '#0ea5e9',
  ...
  dp1: {
    slug: 'diamond-and-pearl',
    accentFrom: '#38bdf8',
    accentTo: '#9d174d',
    blurb: 'Sinnoh begins, with Dialga, Palkia and the first Diamond & Pearl holos.',
  },
  g1: {
    slug: 'generations',
    accentFrom: '#ef4444',
  ...
  sm9: {
    ...
    accentFrom: '#22c55e',
    accentTo: '#14532d',
    blurb: 'Tag Team Pokémon-GX arrive, led by Celebi & Venusaur-GX.',
  },
  sm10: {
    slug: 'unbroken-bonds',
    accentFrom: '#f43f5e',
