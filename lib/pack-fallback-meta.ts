...
> = {
  ...
  base4: { name: 'Base Set 2', series: 'Base', year: '2000', total: 130 },
  base5: { name: 'Team Rocket', series: 'Base', year: '2000', total: 83 },
  gym1: { name: 'Gym Heroes', series: 'Gym', year: '2000', total: 132 },
  ...
  base6: { name: 'Legendary Collection', series: 'Other', year: '2002', total: 110 },
  ecard2: { name: 'Aquapolis', series: 'E-Card', year: '2003', total: 182 },
  ...
  dp1: { name: 'Diamond & Pearl', series: 'Diamond & Pearl', year: '2007', total: 130 },
  ...
  sm9: { name: 'Team Up', series: 'Sun & Moon', year: '2019', total: 198 },
  ...
  cel25: { name: 'Celebrations', series: 'Sword & Shield', year: '2021', total: 50 },
  cel25c: {
  ...
  swsh9: { name: 'Brilliant Stars', series: 'Sword & Shield', year: '2022', total: 216 },
  swsh9tg: {
  ...
  swsh10: { name: 'Astral Radiance', series: 'Sword & Shield', year: '2022', total: 246 },
  swsh10tg: {
  ...
  swsh11: { name: 'Lost Origin', series: 'Sword & Shield', year: '2022', total: 247 },
  swsh11tg: {
  ...
  swsh12: { name: 'Silver Tempest', series: 'Sword & Shield', year: '2022', total: 245 },
  swsh12tg: {
  ...
  swsh12pt5: { name: 'Crown Zenith', series: 'Sword & Shield', year: '2023', total: 230 },
  swsh12pt5gg: {
